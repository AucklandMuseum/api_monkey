...
def step1():
    ...
    querystring = {"q": "primaryRepresentation:http*+-department:%22Archaeology%22&size=1000"}
    payload = "{\r\n\"sort\" : [\r\n{ \r\n\"lastModifiedOn\" : \r\n{\"order\" : \"desc\"} \r\n}\r\n]\r\n}\r\n"
    headers = {
    ...
    if dt_obj.year == 2016 or 2017 or 2018 or 2019:
        ...
        elif 'Maori/Ethnology' in dept:
            print ("cultural permission")
        elif 'Pacific/Ethnology' in dept:
            print ("PCAP")
        elif 'Collection Imaging' in image_location or "Ephemera" in dept or "painting and drawings" in dept or "photography" in dept or "publication" in dept:
            print ("whoop")
